    ...
    function O(t, e, n) {
        ...
        var u = function() {
          ...
          , c = function() {
            ...
            a = c,
            s = t.apply(r, o),
            i || (r = o = null)) : i || !1 === n.trailing || (i = setTimeout(u, l)),
            s
        };
    ...
    var K = {
        ...
        Peek: function(t, e, n) {
            ...
            return b(i, "value", {
                ...
                set: function(t) {
                    v(t) ? (t.before = d(t.before),
                    t.after = d(t.after)) : t = d(t),
                    i._v = t
                }
            }),
            b(i, "reductor", {
            ...
            var i = {
                apply: function(t) {
                    for (var n = 0, i = t.length; n < i; n++) {
                        var r = t[n].style
                          , o = e.Direction.value;
                        r[T[o][0]] = 0 !== n ? "".concat(this.value / 2, "px") : "",
                        n !== t.length - 1 ? r[T[o][1]] = "".concat(this.value / 2, "px") : r[T[o][1]] = ""
                    }
                },
                remove: function(t) {
        ...
        Build: function(t, e, n) {
            var i = {
                ...
                activeClass: function() {
                    ...
                    i && (i.classList.add(n.slide.active),
            ...
            var i = new A
              ...
              , c = {
                ...
                bindSwipeMove: function() {
                    var n = this;
                    i.on(I, e.Html.wrapper, O((function(t) {
                        n.move(t)
                    }
            ...
            var i = new A
              ...
              , o = {
                ...
                addClass: function(e) {
                    var n = t.settings
                      , i = e[t.index];
                    i && i && (i.classList.add(n.classes.nav.active),
                    H(i).forEach((function(t) {
            ...
            var i = new A
              , r = {
                ...
                start: function() {
                    var i = this;
                    this._e && (this.enable(),
                    t.settings.autoplay && m(this._i) && (this._i = setInterval((function() {
                        i.stop(),
                        e.Run.make(">"),
                        i.start(),
                        n.emit("autoplay")
        ...
        Breakpoints: function(t, e, n) {
            ...
            return Object.assign(r, a.match(o)),
            i.on("resize", window, O((function() {
